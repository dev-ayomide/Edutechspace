...
const CyberSecurityStack = () => {
  ...
  const courseSlug = 'cybersecurity';
      ...
      <div className="mx-auto flex flex-col lg:flex-row">
        ...
        <main className="lg:w-4/5 py-3 px-6 lg:px-12 space-y-16">
          ...
          <div className="relative w-full h-[500px] overflow-hidden pb-32">
            <img
              src={course.header_image_url || CyberHeaderImg}
              alt={course.title}
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-4 mt-[-135px]">
              ...
              <p className="text-lg md:text-2xl text-slate-900 max-w-2xl">
                {course.description || "Secure the digital world."}
              </p>
            </div>
            ...
            <div className="relative z-10 grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-blue-100 text-lg mb-8 leading-relaxed">
                  Ready to explore backend technologies? Our Backend Development specialization is recommended for you.
                ...
                <div className="bg-white/10 backdrop-blur-md rounded-xl p-6 border border-white/20">
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-blue-200">Intermediate Specialization</p>
                    </div>
                  </div>
