...
const AiStack = () => {
  ...
  const courseSlug = 'artificial-intelligence';
      ...
      <div className="mx-auto flex flex-col lg:flex-row">
        ...
        <main className="lg:w-4/5 py-3 px-6 lg:px-12 space-y-16">
          ...
          <div className="relative w-full h-[500px] overflow-hidden pb-32">
            <img
              src={course.header_image_url || AIHeaderImg}
              alt={course.title}
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-4 mt-[-135px]">
              ...
              <p className="text-lg md:text-2xl text-slate-900 max-w-2xl">
                {course.description || "Explore the world of AI."}
              </p>
            </div>
            ...
            <div className="relative z-10 grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-blue-100 text-lg mb-8 leading-relaxed">
                  Ready to take your AI skills to the next level? Our Machine Learning specialization is recommended for you.
                  Master advanced algorithms and build complex predictive models.
                </p>
                <Link
