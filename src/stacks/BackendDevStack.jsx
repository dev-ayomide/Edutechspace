...
import BackendHeaderImg from '../assets/images/backendImage.jpg';
...
const BackendDevStack = () => {
  const navigate = useNavigate();
  const courseSlug = 'backend-dev';
      ...
      <div className="mx-auto flex flex-col lg:flex-row">
        ...
        <main className="lg:w-4/5 py-3 px-6 lg:px-12 space-y-16">
          ...
          <div className="relative w-full h-[500px] overflow-hidden pb-32">
            <img
              src={course.header_image_url || BackendHeaderImg}
              alt={course.title}
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-4 mt-[-135px]">
              ...
              <p className="text-lg md:text-2xl text-slate-900 max-w-2xl">
                {course.description || "Master server-side logic."}
              </p>
            </div>
              ...
              <div className="hidden md:block">
                <div className="bg-white/10 backdrop-blur-md rounded-xl p-6 border border-white/20">
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div>
                      <h4 className="font-bold text-xl">Machine Learning</h4>
                      <p className="text-blue-200">Advanced Specialization</p>
                    </div>
                  </div>
...
export default BackendDevStack;
